...
/*********************************************************************
 ...
 Servo Candy Dispenser Variant
 Hobby servo connected to MotorShield servo 1
...
// Attach servo to servo 1 port, running power from motorshield power by cutting trace under board
// and soldering wire from servo power point that is screwed into battery input terminal +
Servo servo1;
...
void setup(void) {  
  ...
  servo1.attach(10); // the servo is attached to Arduino pin 10 via the MotorShield
  servo1.write(170); //rotate the servo to the "upright" position
